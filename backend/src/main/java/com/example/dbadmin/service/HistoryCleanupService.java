...
public class HistoryCleanupService {
    ...
    public HistoryCleanupService(JdbcTemplate jdbc, AppProperties properties) {
        this.jdbc = jdbc;
    ...
    public void cleanup() {
        ...
        purge("audit_log", "created_at", properties.getMaintenance().getAuditRetentionDays(), null, batch);
