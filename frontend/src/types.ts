...
export type BackupTask = { id: number; name: string; connectionId: number; scope: string; cron?: string; lastStatus?: string; lastMessage?: string; lastFilePath?: string; lastFileSize?: number; lastRunAt?: string };
