...
export function TableWorkspace({ activeTable, tableData, tableRows, previewSql, pendingCount, statusMessage, loading, onBackToSql, onReload, onAddRow, onPreview, onCommit, onEdit, onDelete }: {
